  ...
  async sendMessage(text, opts = {}) {
    ...
    const responseP = new Promise(
      async (resolve, reject) => {
        ...
        if (stream) {
          try {
            const stream2 = await this._client.chat.completions.create({
            ...
            for await (const chunk of stream2) {
              const choiceItem = (_a = chunk == null ? void 0 : chunk.choices) == null ? void 0 : _a[0];
              if ((choiceItem == null ? void 0 : choiceItem.finish_reason) === "stop") {
              ...
              console.log((_c = (_b = chunk.choices[0]) == null ? void 0 : _b.delta) == null ? void 0 : _c.content);
            }
          } catch (e) {
          ...
          try {
            ...
            const choiceItem = (_d = res == null ? void 0 : res.choices) == null ? void 0 : _d[0];
